...
#In this part we have filtered this 256 possible options by inducing nibble base fault at the state 
#begining of the second last round. In the following, for loop of l indicate the nibble position 4*l+16*aa,  
